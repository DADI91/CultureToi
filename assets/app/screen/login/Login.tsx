        ...
        <SafeAreaView style={{flex: 1 ,alignItems: 'center', justifyContent: 'center', backgroundColor: '#4682B4'}}>
            <View  style={{marginTop: 350}}>
              ...
              <View  style={styles.StyleText1}>
                ...
                <Text style={{fontWeight:"400", fontSize: 30, color: '#FFFFFF', height: 50, marginTop: 25}}> {"Connexion"} </Text>
              </View>
              ...
              <View style={ styles.StyleText2 }>
                ...
                <TouchableOpacity onPress={() => onPressMDP()}>
                  <Text style={{fontSize: 13, color: '#FFFFFF', height: 50, marginTop: 25, textDecorationLine: 'underline'}}> {"Mot de passe oublié ?"} </Text>
                </TouchableOpacity>
              </View>
              ...
              <View style={{marginTop: 50, alignItems: "center"}}>
                <TouchableOpacity onPress={() => onPressConnexion()}>
                  ...
                  <View style={{backgroundColor: "#969696", width: 330, height: 45, marginTop: 0, borderRadius: 10, alignItems: "center" }}>
                    ...
                    <Text style={{ fontSize: 18, color: '#FFFFFF', marginTop: 10 }}> {"Connexion"} </Text>
                ...
                <TouchableOpacity onPress={() => onPressPasInscrit()}>
                  ...
                  <Text style={{ fontSize: 13, color: '#FFFFFF', height: 50, marginTop: 130 , textDecorationLine: 'underline'}}> {"Pas encore inscrit ? Cliquez ici"} </Text>
