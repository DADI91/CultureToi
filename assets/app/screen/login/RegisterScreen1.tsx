...
import { StyleSheet, Text, View, SafeAreaView, SectionList, StatusBar, TextInput, AppRegistry, Image, TouchableOpacity, Button} from "react-native";
  ...
  useEffect(()=>{
    ...
    .then(querySnapshot => {
      ...
      querySnapshot.forEach(documentSnapshot => {
         ...
         emailExist.push(documentSnapshot.data().email)

      });
      console.log(emailExist.some(item => Email == item))

      if(userNameBD.some(item => user == item) && user !== ""){
        setErrUser("#F96A72")
      ...
      if(emailExist.some(item => Email == item) && Email !== ""){
          setErrEmail("#F96A72")
          setValideSaisie(true)
          return
        ...
        <SafeAreaView style={{flex: 1 ,alignItems: 'center', justifyContent: 'center', backgroundColor: '#4682B4'}}>
            <View  style={{marginTop: 150}}>
              ...
              <View  style={styles.StyleText1}>
                <Text style={{fontWeight:"400", justifyContent: 'center', fontSize: 36, color: '#FFFFFF', height: 50, }}> {"Culture&Moi"} </Text>
                
                <Text style={{fontWeight:"400", fontSize: 30, color: '#FFFFFF', height: 50, marginTop: 48}}> {"Inscription"} </Text>
              </View>
              ...
              <View style={{marginTop: 50, alignItems: "center"}}>
                <TouchableOpacity onPress={() => onPressInscription()}>
                  ...
                  <View style={{backgroundColor: "#969696", width: 330, height: 45, marginTop: 0, borderRadius: 10, alignItems: "center" }}>
                    ...
                    <Text style={{fontWeight:"400", fontSize: 18, color: '#FFFFFF', marginTop: 10 }}> {"Inscription"} </Text>
                ...
                <TouchableOpacity onPress={() => onPressDejaInscrit()}>
                  ...
                  <Text style={{fontSize: 13, color: '#FFFFFF', height: 50, marginTop: 26 , textDecorationLine: 'underline'}}> {"Déja inscrit ? Cliquez ici"} </Text>
